...
export const CARD_BORDER_PAGE_OPTIONS: CardBorderPageOption[] = [
  ...
  { key: "unit-lessons", label: "دروس الوحدة", groups: ["student"], match: (p) => p.startsWith("/dashboard/lessons/") },
  { key: "lessons", label: "الدروس", groups: ["staff"], match: (p) => p === "/dashboard/lessons" },
